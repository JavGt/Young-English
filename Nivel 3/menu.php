   ...
   <nav class="navbar navbar-light navbar-expand-md sticky-top text-dark border-primary shadow-lg d-xl-flex justify-content-xl-start navbar-fixed-top navigation-clean-button" style="background-color: rgb(255,255,255);height: 70px;">
    ...
    <main class="menu" >
        ...
        <div class="main-menu" >
            ...
            <a href="">
                <div class="option" >
                    <img src="./assets/img/compresionauditiva.jpg">
                    <h2>Auditory compression </h2>
                </div>
            </a>
                 <a href="">
                <div class="option" >
                    <img src="./assets/img/compresionlectora.jpg">
                    <h2>Reading compression</h2>
                </div>
            </a>
                    <a href="">
                <div class="option" >
                    <img src="./assets/img/direcciones.jpg">
                    <h2>Addresses</h2>
                </div>
            </a>
