...
<head>
    ...
    <title>Auditory compression</title>
    ...
    <main style="width: 100%;margin: auto;height: 100%;">
        ...
        <div class="d-flex contenido" id="contenido" style="background-color: rgb(255,255,255);width: 100%;max-width: 100%;">
            ...
            <div class="text-lowercase text-center cont" id="cont" style="width: 85%;height: 100%;background-color: #c4eac4;">
              ...
              <h1 id=titulo>Auditory compression</h1>
               <div id="caja4"> Listening comprehension is developing the student's phonemic ear. ... In this sense, listening becomes a fundamental social component for practically every human being, except perhaps people who do not have the sense of hearing</div>
                 
                <div >
                    <img id="audifonos" src="./assets/img/audifonos.png">
                </div>
            </div>
        </div>
    </main>
