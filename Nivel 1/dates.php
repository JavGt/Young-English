 ...
 <nav class="navbar navbar-light navbar-expand-md sticky-top text-dark border-primary shadow-lg d-xl-flex justify-content-xl-start navbar-fixed-top navigation-clean-button" style="background-color: rgb(255,255,255);height: 70px;">
    ...
    <main style="width: 100%;margin: auto;height: 100%;">
        ...
        <div class="d-flex contenido" id="contenido" style="background-color: rgb(255,255,255);width: 100%;max-width: 100%;">
            ...
            <div id="cont" style="background-color:#D6EAF8; padding-right: 20%;  " >
                ...
                <div class="container-all" id="modal">
                 ...
                 <label class="t" > Months of the year - Meses del año</label><!--Titulo del ejercicio-->
                
                <div style="padding-left: 5%; padding-top: 2%;  display: flex;  flex-wrap: wrap;" class="conteiner" ><!--Texto o contenido de la pagina-->
                    <div class="contenedor_tarjeta">
                        <figure id="tarjeta">
                            <img src="assets/img/1_m.jpg" class="frontal" alt="">
                            <figcaption class="trasera">
                                <h2 class="titulo">MONTH:</h2>
                                <hr>
                                <p>Enero</p>
                            </figcaption>
                        </figure>
                        ...
                        <div class="contenedor_tarjeta">
                        <figure id="tarjeta">
                            <img src="assets/img/2_m.jpg" class="frontal" alt="">
                            <figcaption class="trasera">
                                <h2 class="titulo">MONTH:</h2>
                                <hr>
                                <p>Febrero</p>
                        ...
                        <div class="contenedor_tarjeta">
                        <figure id="tarjeta">
                            <img src="assets/img/3_m.jpg" class="frontal" alt="">
                            <figcaption class="trasera">
                                <h2 class="titulo">MONTH:</h2>
                                <hr>
                                <p>Marzo</p>
                        ...
                        <div class="contenedor_tarjeta">
                        <figure id="tarjeta">
                            <img src="assets/img/4_m.jpg" class="frontal" alt="">
                            <figcaption class="trasera">
                                <h2 class="titulo">Month:</h2>
                                <hr>
                                <p>Abril</p>
                        ...
                        <div class="contenedor_tarjeta">
                        <figure id="tarjeta">
                            <img src="assets/img/5_m.jpg" class="frontal" alt="">
                            <figcaption class="trasera">
                                <h2 class="titulo">MONTH:</h2>
                                <hr>
                                <p>Mayo</p>
                        ...
                        <div class="contenedor_tarjeta">
                        <figure id="tarjeta">
                            <img src="assets/img/6_m.jpg" class="frontal" alt="">
                            <figcaption class="trasera">
                                <h2 class="titulo">MONTH:</h2>
                                <hr>
                                <p>Junio</p>
                        ...
                        <div class="contenedor_tarjeta">
                        <figure id="tarjeta">
                            <img src="assets/img/7_m.jpg" class="frontal" alt="">
                            <figcaption class="trasera">
                                <h2 class="titulo">MONTH:</h2>
                                <hr>
                                <p>Julio</p>
                        ...
                        <div class="contenedor_tarjeta">
                        <figure id="tarjeta">
                            <img src="assets/img/8_m.jpg" class="frontal" alt="">
                            <figcaption class="trasera">
                                <h2 class="titulo">MONTH:</h2>
                                <hr>
                                <p>Agosto</p>
                        ...
                        <div class="contenedor_tarjeta">
                        <figure id="tarjeta">
                            <img src="assets/img/9_m.jpg" class="frontal" alt="">
                            <figcaption class="trasera">
                                <h2 class="titulo">MONTH:</h2>
                                <hr>
                                <p>Septiembre</p>
                        ...
                        <div class="contenedor_tarjeta">
                        <figure id="tarjeta">
                            <img src="assets/img/10_m.jpg" class="frontal" alt="">
                            <figcaption class="trasera">
                                <h2 class="titulo">MONTH:</h2>
                                <hr>
                                <p>Octubre</p>
                        ...
                        <div class="contenedor_tarjeta">
                        <figure id="tarjeta">
                            <img src="assets/img/11_m.jpg" class="frontal" alt="">
                            <figcaption class="trasera">
                                <h2 class="titulo">MONTH:</h2>
                                <hr>
                                <p>Noviembre</p>
                        ...
                        <div class="contenedor_tarjeta">
                        <figure id="tarjeta">
                            <img src="assets/img/12_m.jpg" class="frontal" alt="">
                            <figcaption class="trasera">
                                <h2 class="titulo">MONTH:</h2>
                                <hr>
                                <p>Diciembre</p>
