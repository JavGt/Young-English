                ...
                <div class="container-all" id="modal">
                    ...
                    <div class="popup">
                        ...
                        <div class="container-text">
                            ...
                            <h5>Coloca las Respuestas correctas</h5>

                            <div id="resultado"> </div>


                            <form name="Exercise" onsubmit="return verificar_body()"  method="POST" >
                            <div class="co" >
                                <p>¿Where is the trachea?</p>

                                <select style="width: 200px;" name="p1" >
                                    <option></option>
                                    <option value="a" >Head</option>
                                    <option value="b" >Torso</option>
                                    <option value="c" >Lower part</option>
                                </select>

                             <p>What function do the lungs do</p>
                            <select style="width: 200px;" name="p2">
                                <option></option>
                                <option value="a" >Bombear sangre</option>
                                <option value="b" >Bombear aire</option>
                                <option value="c" >Digerir alimentos</option>
                                <option value="d" >Elimina el exceso de agua</option>

                            </select>

                             <p>What is the area that covers the heart called</p>
                            <select style="width: 200px;" name="p3">
                                <option></option>
                                <option value="a" >Costilla</option>
                                <option value="b" >Columna</option>
                                <option value="c" >Abdomen</option>
                                <option value="d" >Cresta iliaca</option>
                            </select>
                            ...
                            <select style="width: 200px;" name="p4">
                                <option></option>   
                                <option></option>
                                <option value="a" >Pelvis</option>
                                <option value="b" >Femur</option>
                                <option value="c" >Rotula/option>
                                <option value="d" >Tarso</option>
                 ...
                 <label class="t" >Body parts</label>
                
                <div class="conteiner" >
                    <div class="box" >
                        <img height="420" width="350" src="assets/img/cabeza.jpg">
                        <span>Head</span>
                    </div>
                    <div class="box" >
                        <img height="420" width="350" src="assets/img/torso.jpg">
                        <span>Torso</span>
                    </div>
                    <div class="box" >
                        <img  src="assets/img/parte inferior.jpg">
                        <span>Lower part</span>
                    </div>
                    <div class="box" >
                        <img  src="assets/img/organos.jpg">
                        <span>Organs </span>
                    </div>
                </div>
